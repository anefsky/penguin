app.controller("todoPaginationCtrl", function($scope, utils, paginationService) {

	var _sharedPaginationData;
	var _key = 'todoListPaging';  // TODO: move to ng-init?
	...
	$scope.$on('do-clear-bids-list', function() { // TODO: remove from here?
		reset();
	});
	...
	$scope.resetToFirstPage = function() {
